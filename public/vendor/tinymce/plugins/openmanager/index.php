	...
	<ul class="nav nav-tabs">
		...
		<li<?php echo ($tabno==2)?" class=\"active\"":""; ?>><a href="#media" data-toggle="tab">Browse Media</a></li>
			...
			else
			{
				$ubuttontext = "Файл";
			?>
		<li class="active"><a href="#home" data-toggle="tab" id="uploadtab">Файл хуулах</a></li>
		<li><a href="#images" data-toggle="tab" id="browsetab">Хуулсан файлууд</a></li>
			<?php
			}
			?>
	</ul>
					...
					<div class="row fileupload-buttonbar">
						<div class="span7" style="width:95%;float:left;">
						   ...
						   <span class="btn btn-small btn-success fileinput-button">
								<span><i class="icon-plus icon-white"></i><?php echo $ubuttontext; ?> нэмэх</span>
