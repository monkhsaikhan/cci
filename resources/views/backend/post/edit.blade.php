...
@section('content')
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="box">
                {!! Form::open(['class' => 'form-horizontal', 'route' => ['admin.post.update', $post->getKey()], 'method' => 'PATCH']) !!}
                <!-- /.box-header -->
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::text('title', $post->title, ['class' => 'form-control', 'placeholder' => 'Гарчиг']) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                {!! Form::select('category_id', $categories, $post->category_id, ['class' => 'form-control', 'placeholder' => 'Төрөл сонгох']) !!}
                            </div>
                        </div>
                        <div class="form-group">
